...
export default function LivePosition() {
  ...
  return (
    <div style={{
      ...
      <div style={{ fontSize: 11, color: '#6366f1', fontWeight: 700, textTransform: 'uppercase',
        letterSpacing: '0.1em', marginBottom: 10 }}>
        🔢 Open Multiplier Position
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(130px, 1fr))', gap: 12 }}>
        ...
        <div>
          ...
          <div style={{ fontSize: 11, color: '#64748b' }}>{pos.contract_type} × {pos.multiplier}x</div>
        </div>
        ...
        <div>
          ...
          <div style={{ fontSize: 11, color: '#64748b' }}>1:{(pos.tp_amount/pos.sl_amount).toFixed(1)} RR</div>
        </div>
        ...
        <div>
          ...
          <div style={{ fontSize: 11, color: '#64748b' }}>
            {pos.multiplier > 50 ? '⚡ High conviction (75x)' : 'Standard (50x)'}
          </div>
        </div>
      ...
      <div style={{ marginTop: 14 }}>
        ...
        <div style={{ textAlign: 'center', fontSize: 10, color: '#64748b', marginTop: 4 }}>
          Breakeven: 33.3% WR · Stake: ${pos.stake.toFixed(2)} · SL/TP guaranteed by Deriv
        </div>
      </div>
    </div>
  )
