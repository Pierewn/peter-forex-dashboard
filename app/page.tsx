...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen" style={{ background: '#060B14', color: '#F1F5F9' }}>
      ...
      <div className="max-w-screen-2xl mx-auto px-6 py-5">
        ...
        {!loading && !error && trades.length === 0 && (
          <div className="flex flex-col items-center justify-center py-24 gap-4">
            ...
            <div className="text-sm" style={{ color: '#64748B' }}>Bot v17.0 runs 24/7 on Railway. First trade incoming.</div>
          </div>
        )}
              ...
              <>
                ...
                >
                  <div className="text-xs font-bold tracking-widest mb-4" style={{ color: '#64748B' }}>
                    INSTRUMENT MODE — v17.0 ADAPTIVE ENGINE
                  </div>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3">
                    {[
                      {
                        title: 'Full Top-Down Read (v17.0)',
                ...
                >
                  ...
                  <div>
                    <div className="text-sm font-bold mb-1" style={{ color: '#F1F5F9' }}>
                      {wr >= 52.1
                        ? `v17.0 Clean-Slate Engine — ${trades.length} trades · WR ${wr}% · Above 52.1% BE = +EV`
      ...
      >
        Last refresh {lastRefresh.toLocaleTimeString()} · Supabase · Railway · PeterBot v17.0 · {new Date().toISOString().slice(0, 10)}
      </div>
    </div>
  )
}
